...
if((difftime(max(ys$date),min(ys$date), units='days')<=21) & loc=="1" & spn>1) {
  
  for (i in seq_len(n_pages1)) {
  
  print(ggplot(ys, aes(x= date, y= percentile))+
  geom_point(ys, size=3, shape=1, 
             mapping = aes(x=date, y= percentile, color=activity_level))+
  xlab("Night")+ #set x-axis
  ylab("Bat Activity Level (Percentile)")+
...
if((difftime(max(ys$date),min(ys$date), units='days')<=21) & loc>1 & loc<5 & spn>1) {
...
if((difftime(max(ys$date),min(ys$date), units='days')<=21) & loc>=5 & spn>1) {
...
if((difftime(max(ys$date),min(ys$date), units='days')>21) & (difftime(max(ys$date),min(ys$date), units='days')<50) & loc=="1" & spn>1) { 
...
if((difftime(max(ys$date),min(ys$date), units='days')>21) & (difftime(max(ys$date),min(ys$date), units='days')<50) & loc>1 & loc<5 & spn>1){
...
if((difftime(max(ys$date),min(ys$date), units='days')>21) & (difftime(max(ys$date),min(ys$date), units='days')<50) & loc>=5 & spn>1) {
...
if((difftime(max(ys$date),min(ys$date), units='days')>50) & (difftime(max(ys$date),min(ys$date), units='days')<300) & loc=="1" & spn>1) {
...
if((difftime(max(ys$date),min(ys$date), units='days')>50) & (difftime(max(ys$date),min(ys$date), units='days') <300) & loc>=5 & spn>1) {
...
if((difftime(max(ys$date),min(ys$date), units='days')>=300) & loc=="1" & spn>1) {
...
if((difftime(max(ys$date),min(ys$date), units='days')>=300) & loc>1 & loc<5 & spn>1) {
...
if((difftime(max(ys$date),min(ys$date), units='days')>=300) & loc>=5 & spn>1) {
