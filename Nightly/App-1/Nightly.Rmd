...
**Table 4.** Summary table showing key metrics for each species recorded. The reference range is the number of nights for each species that your data were compared to. We recommend a Reference Range of 2000+ to be confident in the relative activity level.
...
# Survey Effort
**Table 24. The number of survey nights per month per detector.**
