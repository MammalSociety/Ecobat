...
#B_data <- read.csv("./test_data3.csv")
...
## horrible bit of code that basically works out the start and end dates of each time the detector is active through time
...
## the for statement plots the graphs over multiple pages using facet_grid_paginate otherwise they're too squashed up
...
`r if((difftime(max(df$Night),min(df$Night), units='days')<=21) & loc>5 & spn>1) {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>21) & (difftime(max(df$Night),min(df$Night), units='days')<=50) & loc=="1" & spn=="1") {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>21) & (difftime(max(df$Night),min(df$Night), units='days')<=50) & loc>1 & loc<=5 & spn>1) {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>21) & (difftime(max(df$Night),min(df$Night), units='days')<=50) & loc>5 & spn>1) {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>50) & (difftime(max(df$Night),min(df$Night), units='days')<=300) & loc=="1" & spn=="1") {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>50) & (difftime(max(df$Night),min(df$Night), units='days')<=300) & loc>1 & loc<=5 & spn>1) {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>50) & (difftime(max(df$Night),min(df$Night), units='days')<=300) & loc>5 & spn>1) {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>300) & loc=="1" & spn=="1") {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>300) & loc>1 & loc<=5 & spn>1) {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
`r if((difftime(max(df$Night),min(df$Night), units='days')>300) & loc>5 & spn=="1") {'**Figure 3.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
```{r fig.width=9, fig.height=12}
## Night ~ percentile graph if >5 location + >1 species
#if data spans more than a year
...
## in this bit of code we have to 'infer zeros' on nights when some species were recorded but not others. So spread the data out and include 0s where NAs
