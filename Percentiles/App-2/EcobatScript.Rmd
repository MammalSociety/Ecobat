...
#df <- read.csv("//smbhome.uscs.susx.ac.uk/brs28/Downloads/download (6).csv")
...
wp$Dates <- as.Date(wp$date, format="%d/%m/%Y")

if (NA %in% wp$Dates) {
  wp$Dates <- as.Date(wp$date, format="%Y/%m/%d")
}
...
mdata2 <- ddply(please, c("location_name", "species"), summarise,
               ...
               Number.nights = length(Dates), #returns how many nights of data in the dataset
...
#boxplot if more than 5 but less than 10 locations and more than one species
...
#boxplot if more than or equal to 10 locations and more than one species
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')<=21) & loc=="1" & spn=="1"){ graphD<-ggplot(wp, aes(x= Dates, y= percentile)) +
  geom_point(wp, size=3, shape=1,
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
  scale_colour_manual(values=cbbPalette, name="Activity\nLevel",
                      breaks=c("High","Moderate/High","Moderate",
                               "Low/Moderate","Low"))+
  scale_y_continuous(breaks=seq(0,100,20), limits=c(0,100)) + 
  scale_x_Dates(name = "Date", date_breaks = "3 days", date_labels = "%d %b %Y")+
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_rect(linetype="blank"),
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')<=21) & loc=="1" & spn=="1") {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`

```{r fig.width=9, fig.height=8}
## date ~ percentile graph if 1 location, >1 species
#if less than or equal to 21 days

if((difftime(max(wp$Dates),min(wp$Dates), units='days') <= 21) & loc=="1" & spn>1){
  
  for (i in seq_len(n_pages1)) {
  
  print(ggplot(wp, aes(x= Dates, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')<=21) & loc>=2 & loc<=5 & spn>1) {
  
  for (i in seq_len(n_pages)) {
  
  print(ggplot(wp, aes(x= Dates, y= percentile))+
  geom_point(wp, size=3, shape=1,
             mapping = aes(x=wp$Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
  scale_colour_manual(values=cbbPalette, name="Activity\nLevel",
                      breaks=c("High","Moderate/High","Moderate",
                               "Low/Moderate","Low"))+
  scale_y_continuous(breaks=seq(0,100,20), limits=c(0,100)) + 
  scale_x_date(name = "Date", date_breaks = "1 day", date_labels = "%d %b %Y")+
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour="black", linetype="solid"),
...
#end code for date graph
```
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')<=21) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`

```{r fig.width=9, fig.height=10}
# date ~ percentile graph if 1 species and 2-5 locations
#less than or equal to 21 days 

if((difftime(max(wp$Dates),min(wp$Dates), units='days')<=21) & loc>=2 & loc<=5 & spn=="1") {graphE<-ggplot(wp, aes(x= Dates, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')<=21) & loc>5 & spn>1) {
  
  for (i in seq_len(n_pages)) { 
    
  print(ggplot(wp, aes(x= wp$Dates, y= percentile))+
  geom_point(wp, size=3, shape=1,
             mapping = aes(x=wp$Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')<=21) & loc>5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
```{r fig.width=9, fig.height=8}
## date ~ percentile graph if 1 location, 1 species
#if time difference is between 22 - 50 days 

if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc=="1" & spn=="1"){ graphG<-ggplot(wp, aes(x= Dates, y= percentile)) +
  geom_point(wp, size=3, 
             mapping = aes(x=Dates, y= percentile, color=activity_level, shape=1))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
  scale_colour_manual(values=cbbPalette, name="Activity\nLevel",
                      breaks=c("High","Moderate/High","Moderate",
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc=="1" & spn=="1") {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`

```{r fig.width=6, fig.height=8}
## date ~ percentile graph if 1 location, >1 species
#if time difference is between 22-50 days 

if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc=="1" & spn>1) { 
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc>=2 & loc<=5 & spn>1){
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc>=2 & loc<=5 & spn=="1"){ graphh<-ggplot(wp, aes(x= Dates, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc>5 & spn>1) {
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>=22) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=50) & loc>5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
```{r fig.width=9, fig.height=8}
## date ~ percentile graph if 1 location, 1 species
#if time diff between 51-300 days

if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=300) & loc=="1" & spn=="1"){ ggplot(wp, aes(x= Dates, y= percentile)) +
   geom_point(wp, size=3, shape=1, 
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days') <=300) & loc=="1" & spn=="1") {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`

```{r fig.width=9, fig.height=10}
## date ~ percentile graph if 1 location, >1 species
#if time diff between 51-300 days

if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=300) & loc=="1" & spn>1) {
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=300) & loc>=2 & loc<=5 & spn>1) {
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=300) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=300) & loc>=2 & loc<=5 & spn=="1"){ graphk<-ggplot(wp, aes(x= Dates, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=300) & loc>5 & spn>1) {
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>50) & (difftime(max(wp$Dates),min(wp$Dates), units='days')<=300) & loc>5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
```{r fig.width=9, fig.height=8}
## date ~ percentile graph if 1 location, 1 species
#if data spans more than 300 days

if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc=="1" & spn=="1") {graphm<-ggplot(wp, aes(x= Dates, y= percentile)) +
  geom_point(wp, size=3, shape=1,
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc=="1" & spn=="1") {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`

```{r fig.width=9, fig.height=8}
## date ~ percentile graph if 1 location, >1 species
#if data spans more than a year

if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc=="1" & spn>1) {
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc>=2 & loc<=5 & spn>1) {
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc>=2 & loc<=5 & spn=="1") {graphn<-ggplot(wp, aes(x= Dates, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=Dates, y= percentile, color=activity_level))+
...
if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc>5 & spn>1) {
...
`r if((difftime(max(wp$Dates),min(wp$Dates), units='days')>300) & loc>5 & spn=="1") {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
