...
df <- read.csv("//smbhome.uscs.susx.ac.uk/brs28/Downloads/reecobat/ST C per Night.csv")
...
#end code for date graph
```
`r if((difftime(max(wp$date),min(wp$date), units='days')<=21) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`

```{r fig.width=9, fig.height=10}
# date ~ percentile graph if 1 species and 2-5 locations
#less than or equal to 21 days 

if((difftime(max(wp$date),min(wp$date), units='days')<=21) & loc>=2 & loc<=5 & spn=="1") {graphE<-ggplot(wp, aes(x= date, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=date, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc=="1" & spn=="1"){ graphG<-ggplot(wp, aes(x= date, y= percentile)) +
...
`r if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc=="1" & spn=="1") {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey.  '}`

```{r fig.width=6, fig.height=8}
## date ~ percentile graph if 1 location, >1 species
#if time difference is between 22-50 days 

if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc=="1" & spn>1) { 
...
if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc>=2 & loc<=5 & spn>1){
...
`r if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc>=2 & loc<=5 & spn=="1"){ graphh<-ggplot(wp, aes(x= date, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=date, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc>5 & spn>1) {
...
`r if((difftime(max(wp$date),min(wp$date), units='days')>=22) & (difftime(max(wp$date),min(wp$date), units='days')<=50) & loc>5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
if((difftime(max(wp$date),min(wp$date), units='days')>50) & (difftime(max(wp$date),min(wp$date), units='days')<=300) & loc>=2 & loc<=5 & spn>1) {
...
`r if((difftime(max(wp$date),min(wp$date), units='days')>50) & (difftime(max(wp$date),min(wp$date), units='days')<=300) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
if((difftime(max(wp$date),min(wp$date), units='days')>50) & (difftime(max(wp$date),min(wp$date), units='days')<=300) & loc>=2 & loc<=5 & spn=="1"){ graphk<-ggplot(wp, aes(x= date, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=date, y= percentile, color=activity_level))+
  xlab("\nNight")+ #set x-axis
  ylab("Bat Activity Level (Percentile)\n")+
...
if((difftime(max(wp$date),min(wp$date), units='days')>300) & loc>=2 & loc<=5 & spn>1) {
...
`r if((difftime(max(wp$date),min(wp$date), units='days')>300) & loc>=2 & loc<=5 & spn>1) {'**Figure 2.**\n The activity level (percentile) of bats recorded across each night of the bat survey, split by location and species.  '}`
...
if((difftime(max(wp$date),min(wp$date), units='days')>300) & loc>=2 & loc<=5 & spn=="1") {graphn<-ggplot(wp, aes(x= date, y= percentile))+
  geom_point(wp, size=3, shape=1, 
             mapping = aes(x=date, y= percentile, color=activity_level))+
